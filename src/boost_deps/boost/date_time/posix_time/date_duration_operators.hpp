...
namespace posix_time {
  ...
  inline
  ptime 
  operator+(const ptime& t, const vinaboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const vinaboost::gregorian::months& m)
  {
  ...
  inline
  ptime 
  operator+(const ptime& t, const vinaboost::gregorian::years& y)
  {
  ...
  inline
  ptime 
  operator+=(ptime& t, const vinaboost::gregorian::years& y)
  {
    return t += y.get_offset(t.date());
  }
