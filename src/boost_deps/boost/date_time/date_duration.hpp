...
namespace date_time {
  ...
  class date_duration : private
              vinaboost::less_than_comparable1< date_duration< duration_rep_traits >
            , vinaboost::equality_comparable1< date_duration< duration_rep_traits >
            , vinaboost::addable1< date_duration< duration_rep_traits >
            , vinaboost::subtractable1< date_duration< duration_rep_traits >
            , vinaboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  { 
  public:
  ...
  {
    typedef long int_type;
    typedef vinaboost::date_time::int_adapter<long> impl_type;
