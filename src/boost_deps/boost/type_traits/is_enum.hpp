...
# else
    template <class U> static ::vinaboost::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(BOOST_MSVC, == 1300)                 \
    || BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::vinaboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::vinaboost::type_traits::yes_type));
#  else
    template <class U>
    static ::vinaboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::vinaboost::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : ::vinaboost::is_convertible<typename vinaboost::add_reference<T>::type,::vinaboost::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::vinaboost::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::vinaboost::type_traits::ice_or<
           ::vinaboost::is_arithmetic<T>::value
         , ::vinaboost::is_reference<T>::value
         , ::vinaboost::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::vinaboost::detail::is_enum_helper<
          ::vinaboost::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::vinaboost::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::vinaboost::detail::is_enum_impl<T>::value)
