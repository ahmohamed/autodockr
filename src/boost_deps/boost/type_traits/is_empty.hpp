    ...
    BOOST_STATIC_CONSTANT(
        bool, value = (
            ::vinaboost::type_traits::ice_or<
              ::vinaboost::detail::empty_helper<cvt,::vinaboost::is_class<T>::value>::value
              , BOOST_IS_EMPTY(cvt)
            >::value
            ));
};
...
struct is_empty_impl
{
   ...
   BOOST_STATIC_CONSTANT(
       bool, value = (
           ::vinaboost::type_traits::ice_or<
              ::vinaboost::detail::empty_helper<
                  cvt
                , ::vinaboost::is_class<T>::value
                , ::vinaboost::is_convertible< r_type,int>::value
              >::value
              , BOOST_IS_EMPTY(cvt)
           >::value));
};
...
struct is_empty_impl
{
   typedef ::vinaboost::detail::empty_helper_chooser<
      ::vinaboost::type_traits::ice_and<
         ::vinaboost::type_traits::ice_not< ::vinaboost::is_reference<T>::value >::value,
         ::vinaboost::type_traits::ice_not< ::vinaboost::is_convertible<T,double>::value >::value,
         ::vinaboost::type_traits::ice_not< ::vinaboost::is_pointer<T>::value >::value,
         ::vinaboost::type_traits::ice_not< ::vinaboost::is_member_pointer<T>::value >::value,
         ...
         ::vinaboost::type_traits::ice_not<
            ::vinaboost::is_convertible<T,void const volatile*>::value
            >::value
      >::value > chooser;
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::vinaboost::type_traits::ice_or<eh_type::value, BOOST_IS_EMPTY(T)>::value));
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_empty,T,::vinaboost::detail::is_empty_impl<T>::value)
