...
private:
    virtual void destroy(/*const*/ void *address) const {
        vinaboost::serialization::access::destroy(static_cast<T *>(address));
    }
protected:
    // protected constructor since it's always created by singleton
    explicit iserializer() :
        basic_iserializer(
            vinaboost::serialization::singleton<
                BOOST_DEDUCED_TYPENAME 
                vinaboost::serialization::type_info_implementation<T>::type
            >::get_const_instance()
        )
    {}
public:
    ...
    virtual bool class_info() const {
        return vinaboost::serialization::implementation_level<T>::value 
            >= vinaboost::serialization::object_class_info;
    }
    virtual bool tracking(const unsigned int /* flags */) const {
        return vinaboost::serialization::tracking_level<T>::value 
                == vinaboost::serialization::track_always
            || ( vinaboost::serialization::tracking_level<T>::value 
                == vinaboost::serialization::track_selectively
                && serialized_as_pointer());
    }
    virtual unsigned int version() const {
        return ::vinaboost::serialization::version<T>::value;
    }
    virtual bool is_polymorphic() const {
        return vinaboost::is_polymorphic<T>::value;
    }
    virtual ~iserializer(){};
};
...
BOOST_DLLEXPORT void iserializer<Archive, T>::load_object_data(
    ...
    if(file_version > version())
        vinaboost::serialization::throw_exception(
            archive::archive_exception(
                vinaboost::archive::archive_exception::unsupported_class_version,
                get_debug_info()
            )
        );
    ...
    vinaboost::serialization::serialize_adl(
        vinaboost::serialization::smart_cast_reference<Archive &>(ar),
        * static_cast<T *>(x), 
        file_version
    );
}
...
private:
    virtual const basic_iserializer & get_basic_serializer() const {
        return vinaboost::serialization::singleton<
...
{
    // vinaboost::has_new_operator<T> doesn't work on these compilers
    #if DONT_USE_HAS_NEW_OPERATOR
...
public:
    ...
    ~auto_ptr_with_deleter(){
        if (m_p)
            vinaboost::serialization::access::destroy(m_p);
    }
    T* get() const {
        return m_p;
    }
...
) const
{
    ...
    if(NULL == ap.get())
        vinaboost::serialization::throw_exception(std::bad_alloc()) ;
    ...
    BOOST_TRY {
        ...
        vinaboost::serialization::load_construct_data_adl<Archive, T>(
            ar_impl,
            t, 
            file_version
        );
    ...
    ar_impl >> vinaboost::serialization::make_nvp(NULL, * t);
    ap.release();
}
...
struct load_non_pointer_type {
    ...
    struct load_only {
        ...
        static void invoke(Archive & ar, const T & t){
            ...
            vinaboost::serialization::serialize_adl(
                ar, 
                const_cast<T &>(t), 
                vinaboost::serialization::version<T>::value
            );
        }
    };
    ...
    static void invoke(Archive & ar, T &t){
        typedef BOOST_DEDUCED_TYPENAME mpl::eval_if<
                // if its primitive
                mpl::equal_to<
                    vinaboost::serialization::implementation_level<T>,
                    mpl::int_<vinaboost::serialization::primitive_type>
                >,
            ...
            mpl::greater_equal<
                        vinaboost::serialization::implementation_level<T>,
                        mpl::int_<vinaboost::serialization::object_class_info>
                    >,
            // do standard load
        ...
        BOOST_DEDUCED_TYPENAME mpl::eval_if<
            // no tracking
                    mpl::equal_to<
                        vinaboost::serialization::tracking_level<T>,
                        mpl::int_<vinaboost::serialization::track_never>
                >,
                // do a fast load
...
struct load_pointer_type {
    struct abstract
    {
        ...
        static const basic_pointer_iserializer * register_type(Archive & /* ar */){
            ...
            BOOST_STATIC_ASSERT(vinaboost::is_polymorphic<T>::value);
    ...
    static const basic_pointer_iserializer * register_type(Archive &ar, T & /*t*/){
        ...
        typedef BOOST_DEDUCED_TYPENAME
            mpl::eval_if<
                vinaboost::serialization::is_abstract<const T>,
                vinaboost::mpl::identity<abstract>,
                vinaboost::mpl::identity<non_abstract>  
            >::type typex;
    ...
    static T * pointer_tweak(
        const vinaboost::serialization::extended_type_info & eti,
        void * t,
        T &
    ) {
        // tweak the pointer back to the base class
        return static_cast<T *>(
            vinaboost::serialization::void_upcast(
                eti,
                vinaboost::serialization::singleton<
                    BOOST_DEDUCED_TYPENAME 
                    vinaboost::serialization::type_info_implementation<T>::type
...
struct load_enum_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        int i;
        ar >> vinaboost::serialization::make_nvp(NULL, i);
        t = static_cast<T>(i);
    }
};
...
struct load_array_type {
    ...
    static void invoke(Archive &ar, T &t){
        ...
        vinaboost::serialization::collection_size_type count;
        ar >> BOOST_SERIALIZATION_NVP(count);
        if(static_cast<std::size_t>(count) > current_count)
            vinaboost::serialization::throw_exception(
                archive::archive_exception(
                    vinaboost::archive::archive_exception::array_size_too_short
                )
            );
...
inline void load_wrapper(Archive &ar, const T&t, mpl::true_){
    vinaboost::archive::load(ar, const_cast<T&>(t));
}
