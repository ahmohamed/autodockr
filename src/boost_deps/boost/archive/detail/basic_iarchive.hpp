...
class BOOST_ARCHIVE_DECL(BOOST_PP_EMPTY()) basic_iarchive 
{
    ...
    // vinaboost::scoped_ptr<basic_iarchive_impl> pimpl;
    ...
    find(const vinaboost::serialization::extended_type_info & eti) const = 0;
protected:
...
BOOST_TT_BROKEN_COMPILER_SPEC(
    vinaboost::archive::detail::basic_iarchive  
) 
