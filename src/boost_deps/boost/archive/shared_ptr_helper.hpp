...
class shared_ptr_helper {
    typedef std::map<
        void *,
        vinaboost::shared_ptr<const void>
    > collection_type;
...
#else
    template<class Archive, class T>
    friend inline void vinaboost::serialization::load(
        Archive & ar,
        vinaboost::shared_ptr<T> &t,
        const unsigned int file_version
    );
...
//  #ifdef BOOST_SERIALIZATION_SHARED_PTR_132_HPP
    ...
    std::list<vinaboost_132::shared_ptr<void> > * m_pointers_132;
//  #endif
    ...
    BOOST_ARCHIVE_DECL(result_type) get_od(
            ...
            const vinaboost::serialization::extended_type_info * this_type
    );

    template<class T>
    struct non_polymorphic {
        static const vinaboost::serialization::extended_type_info * 
...
//  #ifdef BOOST_SERIALIZATION_SHARED_PTR_132_HPP
    ...
    append(const vinaboost_132::shared_ptr<void> & t);
//  #endif
public:
