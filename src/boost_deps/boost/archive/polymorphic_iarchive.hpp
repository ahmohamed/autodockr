...
public:
    ...
    virtual void load(vinaboost::int64_t & t) = 0;
    virtual void load(vinaboost::uint64_t & t) = 0;
    #endif
    ...
    void load_override(
                ...
                const
                #endif
                vinaboost::serialization::nvp<T> & t,
                int
        ){
        load_start(t.name());
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(vinaboost::archive::polymorphic_iarchive)
