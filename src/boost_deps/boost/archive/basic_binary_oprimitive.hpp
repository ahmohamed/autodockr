...
public:
    ...
    vinaboost::scoped_ptr<std::locale> archive_locale;
...
public:
    ...
    struct use_array_optimization {
        template <class T>  
            ...
            struct apply {  
                typedef BOOST_DEDUCED_TYPENAME vinaboost::serialization::is_bitwise_serializable<T>::type type;  
            };
        #else
            struct apply : public vinaboost::serialization::is_bitwise_serializable<T> {};  
        #endif
    };
    ...
    void save_array(vinaboost::serialization::array<ValueType> const& a, unsigned int)
    {
