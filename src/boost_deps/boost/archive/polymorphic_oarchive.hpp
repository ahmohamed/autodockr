...
public:
    ...
    virtual void save(const vinaboost::int64_t t) = 0;
    virtual void save(const vinaboost::uint64_t t) = 0;
    #endif
    ...
    void save_override(
                ...
                const
                #endif
                ::vinaboost::serialization::nvp<T> & t, int
        ){
        save_start(t.name());
...
// required by export
BOOST_SERIALIZATION_REGISTER_ARCHIVE(vinaboost::archive::polymorphic_oarchive)
