...
class escape : 
    public vinaboost::iterator_adaptor<
        Derived, 
        Base, 
        BOOST_DEDUCED_TYPENAME vinaboost::iterator_value<Base>::type,
        single_pass_traversal_tag,
        BOOST_DEDUCED_TYPENAME vinaboost::iterator_value<Base>::type
    >
{
    typedef BOOST_DEDUCED_TYPENAME vinaboost::iterator_value<Base>::type base_value_type;
    typedef BOOST_DEDUCED_TYPENAME vinaboost::iterator_reference<Base>::type reference_type;
    friend class vinaboost::iterator_core_access;

    typedef BOOST_DEDUCED_TYPENAME vinaboost::iterator_adaptor<
        Derived, 
        Base, 
        base_value_type,
        single_pass_traversal_tag,
   ...
   void increment(){
    ...
    bool m_full;
    BOOST_DEDUCED_TYPENAME vinaboost::iterator_value<Base>::type m_current_value;
public:
    escape(Base base) : 
        super_t(base),
        m_bnext(NULL),
