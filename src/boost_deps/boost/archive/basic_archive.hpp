...
struct class_name_type : private vinaboost::noncopyable {
    char *t;
...
BOOST_CLASS_IMPLEMENTATION(vinaboost::archive::version_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(vinaboost::archive::class_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(vinaboost::archive::class_id_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(vinaboost::archive::class_id_optional_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(vinaboost::archive::class_name_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(vinaboost::archive::object_id_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(vinaboost::archive::object_reference_type, primitive_type)
BOOST_CLASS_IMPLEMENTATION(vinaboost::archive::tracking_type, primitive_type)
