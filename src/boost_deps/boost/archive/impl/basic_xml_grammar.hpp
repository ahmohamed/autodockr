...
private:
    ...
    typedef BOOST_DEDUCED_TYPENAME vinaboost::spirit::chset<CharType> chset_t;
    typedef BOOST_DEDUCED_TYPENAME vinaboost::spirit::chlit<CharType> chlit_t;
    typedef BOOST_DEDUCED_TYPENAME vinaboost::spirit::scanner<
        BOOST_DEDUCED_TYPENAME  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef BOOST_DEDUCED_TYPENAME vinaboost::spirit::rule<scanner_t> rule_t;
