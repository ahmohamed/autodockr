...
basic_text_oprimitive<OStream>::save_binary(
    ...
    typedef 
        vinaboost::archive::iterators::insert_linebreaks<
            vinaboost::archive::iterators::base64_from_binary<
                vinaboost::archive::iterators::transform_width<
                    const char *,
                    6,
                    8
                >
    ...
    vinaboost::archive::iterators::ostream_iterator<CharType> oi(os);
    std::copy(
