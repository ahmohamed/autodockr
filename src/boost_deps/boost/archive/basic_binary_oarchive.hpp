...
public:
    ...
    void save_override(const version_type & t, int){
        ...
        assert(t.t <= vinaboost::integer_traits<unsigned char>::const_max);
        const unsigned char x = static_cast<const unsigned char>(t.t);
        * this->This() << x;
    }
    void save_override(const class_id_type & t, int){
        // upto 32K classes
        assert(t.t <= vinaboost::integer_traits<vinaboost::int_least16_t>::const_max);
        const vinaboost::int_least16_t x = static_cast<const vinaboost::int_least16_t>(t.t); 
        * this->This() << x;
    }
    void save_override(const class_id_reference_type & t, int){
        // upto 32K classes
        assert(t.t <= vinaboost::integer_traits<vinaboost::int_least16_t>::const_max);
        const vinaboost::uint_least16_t x = t.t;
        * this->This() << x;
    }
    void save_override(const object_id_type & t, int){
        // upto 2G objects
        assert(t.t <= vinaboost::integer_traits<vinaboost::uint_least32_t>::const_max);
        const vinaboost::uint_least32_t x = t.t;
        * this->This() << x;
    }
