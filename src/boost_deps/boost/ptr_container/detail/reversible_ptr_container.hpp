...
namespace ptr_container_detail
{
    ...
    public: // typedefs
        ...
        typedef  BOOST_DEDUCED_TYPENAME Config::const_iterator
                                   const_iterator;
        typedef  vinaboost::reverse_iterator< iterator > 
                                   reverse_iterator;  
        typedef  vinaboost::reverse_iterator< const_iterator >     
    ...
    public: // modifiers
        ...
        {
            return erase( vinaboost::begin(r), vinaboost::end(r) );
        }
    ...
    public: // access interface
        ...
        { 
            ...
            return vinaboost::ptr_container_detail::move( ptr ); 
        }
        ...
        { 
            ...
            return vinaboost::ptr_container_detail::move( old );
        }
...
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
    ...
    {                                               \
        return vinaboost::ptr_container_detail::move(base_type::release(i)); \
    }                                               
#else
#define BOOST_PTR_CONTAINER_DEFINE_RELEASE( base_type ) \
