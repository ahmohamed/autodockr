...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::vinaboost::mpl::aux::yes_tag operator|( \
      ::vinaboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::vinaboost::mpl::aux::no_tag operator|( \
      ::vinaboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::vinaboost::mpl::na) >* \
    ); \
/**/
...
::vinaboost::mpl::aux::yes_tag operator|( \
      ::vinaboost::mpl::aux::has_rebind_tag<int> \
    , ::vinaboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
