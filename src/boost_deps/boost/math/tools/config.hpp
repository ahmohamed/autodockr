...
#include <boost/cstdint.hpp> // for vinaboost::uintmax_t
...
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE(t)         vinaboost::type<t>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_TYPE_SPEC(t)    vinaboost::type<t>*
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE(t, v)  vinaboost::non_type<t, v>* = 0
#  define BOOST_MATH_EXPLICIT_TEMPLATE_NON_TYPE_SPEC(t, v)  vinaboost::non_type<t, v>*
...
#define BOOST_MATH_STD_USING \
   ...
   using std::log10;\
   using std::sqrt;\
   using vinaboost::math::round;\
   using vinaboost::math::iround;\
   using vinaboost::math::lround;\
   using vinaboost::math::trunc;\
   using vinaboost::math::itrunc;\
   using vinaboost::math::ltrunc;\
   using vinaboost::math::modf;
...
#  define BOOST_FPU_EXCEPTION_GUARD vinaboost::math::detail::fpu_guard local_guard_object;
