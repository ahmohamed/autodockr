...
{
  typedef vinaboost::random::detail::ptr_helper<UniformRandomNumberGenerator> traits;
  typedef vinaboost::random::detail::pass_through_engine<UniformRandomNumberGenerator> internal_engine_type;
public:
