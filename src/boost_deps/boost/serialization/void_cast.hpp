    ...
    private vinaboost::noncopyable
{
    ...
    friend 
    BOOST_SERIALIZATION_DECL(void const *)  
    vinaboost::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d = 
            vinaboost::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b = 
            vinaboost::serialization::smart_cast<const Base *, const Derived *>(
...
{
    typedef
        BOOST_DEDUCED_TYPENAME mpl::eval_if<vinaboost::is_virtual_base_of<Base,Derived>,
            mpl::identity<
