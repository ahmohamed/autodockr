...
// this is useful for compilers which don't support the vinaboost::is_abstract
...
namespace serialization {
    template<class T>
    struct is_abstract : vinaboost::is_abstract<T> {} ;
} // namespace serialization
} // namespace vinaboost
...
namespace serialization {
    template<class T>
    struct is_abstract : vinaboost::false_type {};
} // namespace serialization
} // namespace vinaboost
...
namespace serialization {                             \
template<>                                            \
struct is_abstract< T > : vinaboost::true_type {};        \
template<>                                            \
struct is_abstract< const T > : vinaboost::true_type {};  \
}}                                                    \
/**/
