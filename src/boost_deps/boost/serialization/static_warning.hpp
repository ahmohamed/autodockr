...
struct static_warning_test{
    typename vinaboost::mpl::eval_if_c<
        B,
        vinaboost::mpl::true_,
        typename vinaboost::mpl::identity<
            vinaboost::mpl::print<
...
#define BSW(B, L) \
    typedef vinaboost::serialization::SS< \
        sizeof( vinaboost::serialization::static_warning_test< B, L > ) \
