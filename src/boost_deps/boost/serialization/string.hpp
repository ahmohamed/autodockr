...
BOOST_CLASS_IMPLEMENTATION(std::string, vinaboost::serialization::primitive_type)
#ifndef BOOST_NO_STD_WSTRING
BOOST_CLASS_IMPLEMENTATION(std::wstring, vinaboost::serialization::primitive_type)
#endif
...
inline void save(
    ...
    vinaboost::serialization::stl::save_collection<
...
inline void load(
    ...
    vinaboost::serialization::stl::load_collection<
        ...
        vinaboost::serialization::stl::archive_input_seq<
            ...
            std::basic_string<U, Allocator> 
        >,
        vinaboost::serialization::stl::reserve_imp<
            std::basic_string<U, Allocator> 
        >
    >(ar, t);
}
