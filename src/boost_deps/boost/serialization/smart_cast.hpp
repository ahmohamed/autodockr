    ...
    typedef
        BOOST_DEDUCED_TYPENAME mpl::eval_if<
            BOOST_DEDUCED_TYPENAME mpl::or_<
                vinaboost::is_same<void *, U>,
                vinaboost::is_same<void *, T>,
                vinaboost::is_same<const void *, U>,
                vinaboost::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer<T> >,
        // else
        BOOST_DEDUCED_TYPENAME mpl::eval_if<vinaboost::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer<T> >,
        // else
        BOOST_DEDUCED_TYPENAME mpl::eval_if<vinaboost::is_reference<U>,
